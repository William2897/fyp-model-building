...
# Arguments
parser = argparse.ArgumentParser(description="Hyperparameter tuning for LinearSVC with TF-IDF")
parser.add_argument('--csv_path', type=str, required=True)
parser.add_argument('--best_model_out', type=str, default='linearsvc_best_model.joblib')
parser.add_argument('--vectorizer_out', type=str, default='tfidf_best_vectorizer.joblib')
parser.add_argument('--results_out', type=str, default='linearsvc_tuning_results.json')
...
def main():
    ...
    param_grid = {
        ...
        'dual': [True, False],
        'max_iter': [2000]  # Keep high max_iter to ensure convergence
    }
